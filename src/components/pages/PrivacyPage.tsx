...
export const PrivacyPage = () => {
  ...
  const principles = [
    ...
    },
    {
      ...
      title: "Security",
      description:
        "Your information is stored securely and accessed only when necessary",
    },
    {
          ...
          <Card className="p-8 lg:p-12 glass-effect border-border/30 space-y-8 mb-12">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 text-foreground/80">
                <li>
                  Account information (phone, email, username, profile picture,
                  date of birth)
                </li>
                <li>Photos and content you share</li>
                <li>Device information and app usage data</li>
                <li>Location data (if you enable location services)</li>
                <li>Contact data (if you enable access to your contacts)</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="text-foreground/80 leading-relaxed">
                ...
                or as needed to provide you services. You may delete your
                account at any time, and we will delete your personal
