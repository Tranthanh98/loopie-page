        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="p-8 lg:p-12 glass-effect border-border/30 space-y-8 mb-12">
            ...
            <section>
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-medium text-golden">
          ...
          <Card className="p-8 lg:p-12 glass-effect border-border/30 mb-8">
              ...
              {cookieTypes.map((cookieType, index) => (
                ...
                >
                  <div className="flex items-start space-x-4">
                    <div className="text-golden mt-1">{cookieType.icon}</div>
                    <div>
                      <h3 className="font-semibold mb-2">{cookieType.title}</h3>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
              <Button className="bg-golden hover:bg-golden-glow text-background font-semibold px-8 py-2 rounded-full">
                Save Preferences
              </Button>
              <Button
                variant="outline"
          ...
          <Card className="p-6 glass-effect border-border/30">
            ...
            <p className="text-foreground/80 mb-4">
              ...
              us at privacy@Loopie.com
            </p>
            <p className="text-sm text-muted-foreground">
              For more information about cookies in general, visit:
              <a
                href="https://www.allaboutcookies.org"
                className="text-golden hover:underline ml-1"
              >
